...
$datesheet_records = $collection->find();
?>

<div class="container page-wrapper">

    <div class="page-header mb-4">
        <h2>Exam Datesheet Management</h2>
        <p>Add, view, edit or delete exam schedules</p>
    </div>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php foreach ($datesheet_records as $record): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button
                                    ...
                                    data-exam_date="<?= $record['exam_date'] ?>"
